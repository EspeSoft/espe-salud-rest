...
public interface PacienteMapper {
    ...
    @Mapping(source = "persona.idProvinciaNacimiento", target = "idProvinciaNacimiento")
    @Mapping(source = "persona.cantonNacimiento", target = "cantonNacimiento")
    @Mapping(source = "persona.idCantonNacimiento", target = "idCantonNacimiento")
    ...
    @Mapping(source = "idProvinciaNacimiento", target = "persona.idProvinciaNacimiento")
    @Mapping(source = "cantonNacimiento", target = "persona.cantonNacimiento")
    @Mapping(source = "idCantonNacimiento", target = "persona.idCantonNacimiento")
