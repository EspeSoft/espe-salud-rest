...
import com.espe.salud.service.antecedente.CertificadoService;
...
public class CertificadoController {
    ...
    public ResponseEntity<CertificadoDTO> update(@RequestBody CertificadoDTO dto,@RequestParam Long codigo){
