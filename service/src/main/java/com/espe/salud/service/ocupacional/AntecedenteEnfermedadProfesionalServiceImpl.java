...
@Service
public class AntecedenteEnfermedadProfesionalServiceImpl implements AntecedenteEmpleoAnteriorService {
    ...
    public AntecedenteEnfermedadProfesionalServiceImpl(AntecedenteEmpleoAnteriorRepository antecedenteEmpleoAnteriorRepository, AntecedenteEmpleoAnteriorMapper mapper) {
