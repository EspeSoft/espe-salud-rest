...
@Service
public class AntecedenteLaboralServiceImpl implements AntecedenteEmpleoAnteriorService {
    ...
    public AntecedenteLaboralServiceImpl(AntecedenteEmpleoAnteriorRepository antecedenteEmpleoAnteriorRepository, AntecedenteEmpleoAnteriorMapper mapper) {
