...
import static com.espe.salud.app.common.Constants.URI_API_V1_FAC_RIE_ACT_ACT;

@RestController
@Tag(name = "Gestiona los antecedentes de empleo anterior de un antecedente laboral")
@RequestMapping(value = URI_API_V1_FAC_RIE_ACT_ACT)
public class FactorRiesgoActividadActualController {

    private final AntecedenteEmpleoAnteriorService antecedenteEmpleoAnteriorService;

    @Autowired
    private FactorRiesgoActividadActualController(AntecedenteEmpleoAnteriorService antecedenteEmpleoAnteriorService) {
