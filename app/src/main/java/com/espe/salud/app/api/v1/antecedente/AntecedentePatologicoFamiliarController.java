...
public class AntecedentePatologicoFamiliarController {
    ...
    public ResponseEntity<List<AntecedentePatologicoFamiliaDTO>> getAll(){
        return new ResponseEntity<>(service.findAll(), HttpStatus.OK);
    }

    @Operation(summary = "Retorna un antecedente patologico familiar por su codigo")
    @GetMapping(value = "/{codigo}", produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<AntecedentePatologicoFamiliaDTO> getById(@Parameter(description = "El codigo del antecedente patologico familiar",required = true,example = "1") @PathVariable("codigo") Long id){
        return new ResponseEntity(service.findById(id),HttpStatus.OK);
    }

    @Operation(summary = "Edita un antecedente patologico familiar por su codigo")
    @PutMapping(value = "/{codigo}",produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<AntecedentePatologicoFamiliaDTO> update(@RequestBody AntecedentePatologicoFamiliaDTO dto,@RequestParam Long codigo){
        Optional<AntecedentePatologicoFamiliaDTO> newAntecedentePatologicoFamiliarDTOoptional=service.findById(codigo);
        AntecedentePatologicoFamiliaDTO newAntecedentePatologicoFamiliaDTO= newAntecedentePatologicoFamiliarDTOoptional.get();
    ...
    @PostMapping("/")
    public ResponseEntity<AntecedentePatologicoFamiliaDTO> save(@RequestBody AntecedentePatologicoFamiliaDTO dto){
