...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler({EspeSaludException.class})
    public ResponseEntity<?> handleVeronicaException(EspeSaludException ex, HttpServletRequest request) {
    ...
    protected ResponseEntity<Object> handleDuplicatedField(
            DuplicatedFieldException ex) {
        ApiError apiError = new ApiError(HttpStatus.CONFLICT, "Duplicated field", ex);
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        return buildResponseEntity(new ApiError(HttpStatus.INTERNAL_SERVER_ERROR, Objects.requireNonNull(ex.getRootCause()).getMessage(), ex));
    }
