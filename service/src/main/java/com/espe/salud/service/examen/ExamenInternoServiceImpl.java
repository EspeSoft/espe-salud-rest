...
public class ExamenInternoServiceImpl implements ExamenInternoService{
    ...
    @Autowired
    public ExamenInternoServiceImpl(ExamenInternoRepository repository, ExamenInternoMapper mapper) {
    ...
    public ExamenInternoDTO save(ExamenInternoDTO dto) {
        ...
        if (optional.isEmpty()) {
            ...
            return mapper.toExamenInternoDTO(repository.save(domainObject));
        }else{
