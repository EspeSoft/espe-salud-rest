...
@Service
public class GrupoCulturalImpl implements GrupoCulturalService {
    private final GrupoCulturalRepository domainRepository;
    private final GrupoCulturalMapper mapper;

    @Autowired
    public GrupoCulturalImpl(GrupoCulturalRepository domainRepository, GrupoCulturalMapper mapper) {
